...
(日本語訳 translated by Mendoxi.
\url{http://www.cam.hi-ho.ne.jp/mendoxi/rfc/rfc2119j.html)}
...
(日本語訳 translated by Suzuki Hisao, published by Yusuke Shinyama.
\url{http://www.unixuser.org/~euske/doc/r5rs-ja/)}
...
(日本語訳 translated by Shiro Kawai.
\url{http://practical-scheme.net/wiliki/wiliki.cgi?R6RS)}
